...
class Registration
{
    ...
    public function sendVerificationEmail($user_id, $user_email, $user_activation_hash)
    {
		...
		<body>
			...
			<a style='font-size: 18px' href='$link'>Confirm activation</a>
		</body>
		</html>";
		$mail->isHTML(true);
        ...
        if ($this->databaseConnection()) {
            ...
            if ($query_update_user->rowCount() > 0) {
				...
				try
				{
					...
					$s->bindValue(':title', 'Welcome to IMGnest');
					$s->bindValue(':messagetext', 
								  'We\'re glad that you have joined us. You will hopefully get a lot of use out of this website. \n This is the messagebox, where you will get notifications when something important has occured. \n\n Click on the big IMGnest logo in the upper left corner to get back to the homepage.');
					$s->bindValue(':fromuser', 0);
					$s->bindValue(':touser', $user_id);
					$s->execute();
				}
				catch(PDOException $e)
				{
